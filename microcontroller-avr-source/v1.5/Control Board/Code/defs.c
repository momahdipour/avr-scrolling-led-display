...
#include "config.c"  //must be included before "ieeprom.c"

#ifdef _DEBUG_
#include "ieeprom.c"  //must be included after "config.c"
#endif
...
eeprom unsigned char MAX_ROW_COUNT = LED_DISPLAY_MAX_ROW_COUNT;
eeprom unsigned char MAX_COL_COUNT = LED_DISPLAY_MAX_COL_COUNT;

#define MAX_ROW_COUNT_FOR_ARRAY LED_DISPLAY_MAX_ROW_COUNT//*** Must be MAX_ROW_COUNT
...
#define CONTENT_SPEED_MULTIPLIER 0.4//Original Value was 0.4
...
#define   USART_TIME_OUT_1      2  //In seconds - For long-time commands
#define   USART_TIME_OUT_2      1  //In seconds - For short-time commands
