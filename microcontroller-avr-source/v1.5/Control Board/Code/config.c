...
#define   LED_DISPLAY_MAX_ROW_COUNT     16   //Can be any value between 4 and 32
#define   LED_DISPLAY_MAX_COL_COUNT     128  //Must be a multiple of 8
//#define     _ROWS_24_
//#define     _ROWS_32_
...
#if defined(_COLOR_DISPLAY_METHOD_2_) || defined(_COLOR_DISPLAY_METHOD_1_)
  #if LED_DISPLAY_MAX_ROW_COUNT == 16
    #ifdef _CHIP_ATMEGA128_
      #define   CACHE_COUNT   55
      #define   CACHE_SIZE    32
    #else
      #if LED_DISPLAY_MAX_COL_COUNT <= 80
...
#define   _INTERNAL_FONTS_MEMORY_SIZE_    0UL  //0 for debugging
