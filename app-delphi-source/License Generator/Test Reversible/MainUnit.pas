...
begin
    ...
    begin
      Application.MessageBox('Error occurred.', 'Critical Error');
      Exit;
    end;
    S2 := CPUID + '|' + BIOSInfo + '|' + MBInfo + '|' + HDSerial;
...
begin
  ...
  AlarmCheck.Enabled := not ColorDisplayRadio.Checked;
  LFGCheck.Enabled := not ColorDisplayRadio.Checked;
end;
